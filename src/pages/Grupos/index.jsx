      ...
      <div className="main-container">
        ...
        <main className="group-area">
          <div className="grupos-header">
            <input type="search" className="search" placeholder="Buscar grupos" />
            <button className="filtros-card filtros-card-active1">
              <span>Todas</span>
            </button>
            <button className="filtros-card">
          ...
          <div className="grupos">
            <div className="grupo gradient-card">
              <a href="grupo">
                ...
                <hr />
                <div className="grupo-info middle-info">
                  <div className="barra-details">
                    <div className="xp-quantidade-grupo">
                      <strong> Nível 12 </strong>
                      <span> 1240 / 2000 XP </span>
                    </div>
                    <div className="xp-barra">
                      <div className="grupo-porcentagem xp-porcentagem1"></div>
                    </div>
                  </div>
              ...
              <a href="grupo">
                ...
                <div className="grupo-info middle-info">
                  <div className="barra-details">
                    ...
                    <div className="xp-barra">
                      <div className="grupo-porcentagem xp-porcentagem2"></div>
                    </div>
                  </div>
                  <div className="grupo-details">
                    <div className="grupo-detail">
            ...
            <div className="grupo grupo2 gradient-card"></div>
            <div className="grupo grupo2 gradient-card"></div>
            <div className="grupo grupo2 gradient-card"></div>
          </div>
          ...
          <aside className="group-view gradient-card">
            ...
            <div className="lateral-info">
              ...
              <div className="barra">
                <div className="xp-barra">
                  <div className="grupo-porcentagem xp-porcentagem"></div>
                </div>
